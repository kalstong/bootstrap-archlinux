...
if [ "$HOST" != "nuc8i7" ]; then
	printerr "ERROR: This configuration file belongs to nuc8i7."
	exit 1
fi
...
cp userfiles/.tool-versions "${HOME}/"
...
gcc ../shared/userfiles/polybar-fsusage.c \
	-std=c99 -Wall -Wextra -O2 -flto -fwhole-program \
...
# 	_forgit_bash_url="https://raw.githubusercontent.com/wfxr/forgit/6385f85360b6fe0a1ac19cd5ce595b4f3921a2a7/forgit.plugin.zsh"
#
...
# 	# Consulted on 2022-05-18
# 	_forgit_fish_url="https://raw.githubusercontent.com/wfxr/forgit/6385f85360b6fe0a1ac19cd5ce595b4f3921a2a7/conf.d/forgit.plugin.fish"
#
